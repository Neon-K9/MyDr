...
class AppointmentController extends Controller
{
    ...
    public function cancel(int $id)
    {
        ...
        if (!$cancelReponse->success) {
            return redirect()->route('appointments.index')->withError('Error Cancellng Appointment');
        }

        return redirect()->route('appointments.index')->withSuccess('Appointment Cancelled!');
    }
